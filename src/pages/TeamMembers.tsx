...
const stateTeams = [
  {
    ...
    members: [
      {
        name: "Appalla Karthik",
        role: "Developer",
        initials: "AK",
        note: "Contributing to the website experience, interface refinement, and ongoing platform improvements.",
      },
      {
        name: "Andhra Pradesh Team",
        role: "State Coordination",
        initials: "AP",
        note: "Supporting regional communication, volunteer coordination, and local activity updates.",
      },
    ],
  },
  {
    ...
    members: [
      {
        name: "West Bengal Team",
        role: "State Coordination",
        initials: "WB",
        note: "Coordinating state outreach, documentation, and community engagement activities.",
      },
    ],
  },
  {
    ...
    members: [
      {
        name: "Uttar Pradesh Team",
        role: "State Coordination",
        initials: "UP",
        note: "Supporting program communication, volunteer connections, and state-wise impact updates.",
      },
    ],
  },
];
      ...
      <div className="container relative z-10 mx-auto px-4">
        <AnimatedSection className="mx-auto mb-10 max-w-4xl text-center md:mb-14">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-muted-foreground sm:text-base">
            Shivarpan Foundation is building state-wise coordination for digital
            support, volunteer communication, and regional outreach.
          </p>
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            {stateTeams.map((team) => (
              <a
                key={team.state}
                href={`#${team.state.toLowerCase().replace(/\s+/g, "-")}`}
        ...
        <div className="space-y-10">
          {stateTeams.map((team, stateIndex) => (
            <AnimatedSection
              key={team.state}
              id={team.state.toLowerCase().replace(/\s+/g, "-")}
